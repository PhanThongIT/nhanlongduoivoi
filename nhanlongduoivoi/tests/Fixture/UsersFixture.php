...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'fullname' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'remember_token' => ['type' => 'string', 'length' => 1000, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'updated_at' => 1537611705,
                'created_at' => 1537611705
            ],
        ];
        parent::init();
    }
